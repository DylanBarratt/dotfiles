...
local ARCH_LOGO = '/home/dylan/.config/awesome/assets/archlinux.svg'
...
local function worker(user_args)
    ...
    local menu_items = {
        { name = 'Log out', icon = '󰗽', command = onlogout },
        { name = 'Lock', icon = '', command = onlock },
        { name = 'Reboot', icon = '', command = onreboot },
        { name = 'Suspend', icon = '', command = onsuspend },
        { name = 'Power off', icon = '', command = onpoweroff },
    }
